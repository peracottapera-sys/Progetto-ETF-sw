...
- L'oro (ETF fisico sull'oro) massimo ${regole.safeHavenMax || 5}% del portafoglio
- ⚠️ VARIETÀ OBBLIGAZIONARIA: includi almeno ${regole.obbligazionarioVarietaMin || 1} sottotipi obbligazionari DISTINTI (es. gov breve + corporate, oppure gov + inflation-linked). Due ETF dello stesso sottotipo (es. due corporate EUR) contano come uno solo.
- ⚠️ LIMITE TEMATICI/SATELLITE: ETF tematici, settoriali o di nicchia (AI, difesa, energia, uranium, ecc.) max ${regole.tematiciMax || 10}% totale del portafoglio. Non superare questo limite anche se il contesto macro li favorisce.
- ⚠️ CATEGORIE MINIME: il portafoglio deve coprire almeno ${regole.categorieMinime || 3} categorie distinte (es. azionario globale, obbligazionario, commodity/safe haven sono 3 categorie diverse).
...
- ⚠️ VINCOLO UNIVERSO AZIONARIO: ETF che tracciano lo stesso universo geografico (es. MSCI World, ACWI, FTSE All-World e loro varianti Value/Growth/Equal Weight/Momentum/Quality) contano come parzialmente sovrapposti. Puoi includere MAX 1 ETF "puro" sull'universo (es. ACWI o World market-cap) + MAX 1 variante smart beta sullo stesso universo (es. World Value o World Equal Weight). NON includere 2 o più varianti smart beta sullo stesso universo (es. World Value + World Equal Weight = vietato). Se vuoi diversificazione stilistica, scegli universi geografici diversi (es. World + Emergenti, oppure World + Europa).
- ⚠️ VINCOLO SOVRAPPOSIZIONE USA: S&P500, Nasdaq-100, Russell 2000 e MSCI USA sono tutti ETF sul mercato USA — tracciano lo stesso paese con varianti settoriali/stilistiche. NON combinare più di 1 ETF USA puro (S&P500 o MSCI USA) con un ETF globale (World/ACWI) che già contiene 60-65% USA: il risultato sarebbe un portafoglio con 70-80% di esposizione USA effettiva, non diversificato. REGOLA: se hai già un ETF World/ACWI, puoi aggiungere al massimo 1 ETF USA specifico (es. S&P500 oppure Nasdaq, non entrambi) solo se il MaxUSA del profilo lo consente. Preferisci invece Emergenti, Europa, Asia o settoriali globali per diversificare.
