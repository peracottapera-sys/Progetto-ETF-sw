...
export default function Layout({ children, activeTab, setActiveTab }) {
  ...
  const navItems = [
    ...
    { id: 'ai-runs', label: 'Storico AI', icon: 'M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zM9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3M12 17h.01' },
    { id: 'logs', label: 'Log Attività', icon: 'M9 5H7a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V7a2 2 0 0 0-2-2h-2M9 5a2 2 0 0 0 2 2h2a2 2 0 0 0 2-2M9 5a2 2 0 0 0-1-1M12 12v4M12 12l-2-2M12 12l2-2' },
  ];
