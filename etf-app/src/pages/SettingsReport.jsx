      ...
      <div style={{ display: 'flex', gap: 16, alignItems: 'flex-start' }}>
        ...
        <div style={{ width: 260, flexShrink: 0 }}>
          ...
          <div className="card" style={{ marginTop: 16 }}>
            <div className="card-title" style={{ fontSize:13 }}>🤖 Motore AI</div>
            <a href="/Regole_AI_ETF_Portfolio.docx" download
              style={{ display:'flex', alignItems:'center', gap:10, padding:'8px 12px', borderRadius:8,
                background:'var(--bg-secondary)', border:'1px solid var(--border)', textDecoration:'none', marginBottom:8 }}>
              <span style={{ fontSize:18 }}>📄</span>
              <div>
                <div style={{ fontWeight:600, fontSize:12, color:'var(--text-primary)' }}>Regole Motore AI</div>
                <div style={{ fontSize:10, color:'var(--text-muted)' }}>Scorecard pesi e parametri — .docx</div>
              </div>
            </a>
          </div>
        </div>
